...
from .views.cliente_view import importacion,listado_clientes,consultar_cliente, exportar_clientes
...
urlpatterns = [
    ...
    path('exportar_clientes', exportar_clientes, name='exportar_clientes')
]
